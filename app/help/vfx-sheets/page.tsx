  ...
  return (
    ...
    >
      <ol className="list-decimal space-y-4 pl-5">
        <li>
          Open <strong className="text-[#f1f0f0]">VFX → VFX sheets</strong> from
          the sidebar, or use{" "}
          <strong className="text-[#f1f0f0]">Generate new VFX sheet</strong>{" "}
        ...
        <li>
          Fill <strong className="text-[#f1f0f0]">Show info</strong> — many
          fields sync from the show you opened. Pick the target episode when
          saving to deliverables.
        </li>
        <li>
          Run <strong className="text-[#f1f0f0]">Generate</strong>. An Excel
        ...
        <li>
          ...
          <strong className="text-[#f1f0f0]">vfx_sheet</strong> deliverable and
